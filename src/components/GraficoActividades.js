...
const GraficoActividades = () => {
    ...
    const colores = [
        ...
        "#DAA520", "#FF00FF", "#BA55D3", "#7B68EE", "#00FA9A", "#8FBC8F", "#FFDAB9", "#191970",
        "#B22222", "#FF69B4", "#CD5C5C", "#4B0082", "#00CED1", "#8B008B", "#ADFF2F", "#7FFFD4",
        "#FF4500", "#FF1493", "#00FF00", "#006400", "#6A5ACD", "#FF4500", "#556B2F", "#DDA0DD",
        "#FF6347", "#2E8B57", "#DC143C", "#20B2AA", "#8A2BE2", "#9932CC", "#FF7F50", "#5D3FD3"
    ];    
